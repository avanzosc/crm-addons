...
class CrmClaim(models.Model):
    ...
    count_phonecall = fields.Integer(
        '# Phone calls', compute='_compute_count_phonecall')
    phonecall_id = fields.Many2one(
        string='Phone call', comodel_name='crm.phonecall')
    ...
    def action_view_phonecall(self):
        ...
        return {
            ...
            "views": [[self.env.ref(
                'crm_phonecall.crm_case_phone_tree_view').id, "tree"],
                [False, "form"]],
