...
class CustomerPortal(CustomerPortal):
    ...
    def _get_searchbar_filters(self):
        ...
        return {
            ...
            "last_week": {
                ...
                "domain": [
                    ("create_date", ">=",
                     date_utils.start_of(last_week, "week")),
                    ("create_date", "<=",
                     date_utils.end_of(last_week, "week"))],
            },
            "last_month": {
                "label": _("Last month"),
                "domain": [
            ...
            "last_year": {
                ...
                "domain": [
                    ("create_date", ">=",
                     date_utils.start_of(last_year, "year")),
                    ("create_date", "<=",
                     date_utils.end_of(last_year, "year"))],
            },
        }
    ...
    def portal_my_claims(
            ...
            filterby=None, search=None, search_in="content", groupby=None,
            **kw):
